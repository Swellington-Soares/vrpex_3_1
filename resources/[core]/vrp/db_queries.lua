...
vRP.prepare('vRP/getPlayer', 'SELECT * FROM vplayers WHERE id = ? AND deleted_at IS NULL')
vRP.prepare('vRP/getPlayerIncludeDeleted', 'SELECT * FROM vplayers WHERE id = ?')
vRP.prepare('vRP/getAllPlayerFromUser', 'SELECT * FROM vplayers WHERE user_id = ? AND deleted_at IS NULL')
vRP.prepare('vRP/getAllPlayerFromUserIncludeDeleted', 'SELECT * FROM vplayers WHERE user_id = ?')
