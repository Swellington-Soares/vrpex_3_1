...
vRP.prepare('vRP/getPlayer', 'SELECT * FROM players WHERE id = ? AND deleted_at IS NULL')
vRP.prepare('vRP/getPlayerIncludeDeleted', 'SELECT * FROM players WHERE id = ?')
vRP.prepare('vRP/getAllPlayerFromUser', 'SELECT * FROM players WHERE user_id = ? AND deleted_at IS NULL')
vRP.prepare('vRP/getAllPlayerFromUserIncludeDeleted', 'SELECT * FROM players WHERE user_id = ?')
vRP.prepare('vRP/getPlayersBy', 'SELECT * FROM players WHERE ?? = ?')
