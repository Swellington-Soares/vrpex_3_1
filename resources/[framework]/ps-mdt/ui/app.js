...
var quotes = [
  ...
  'Acredite em si mesmo e em tudo que você é. Saiba que há algo dentro de você maior do que qualquer obstáculo.',
  ...
  'A maior glória em viver não está em nunca cair, mas em se levantar toda vez que caímos.',
  'Os dois dias mais importantes da sua vida são o dia em que você nasce e o dia em que você descobre por quê.',
  'Sucesso não é o quão alto você subiu, mas o quanto você fez diferença positiva no mundo.',
];
...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    $(".manage-profile-editing-title").html(`Você está editando no momento ${result["firstname"]} ${result["lastname"]}`);
    ...
    let convHTML = '<div style="color: #fff; text-align:center;">Ficha Limpa</div>';
    ...
    if (canCreateBulletin == 0) {
      ...
      $(".bulletin-items-continer")
        .prepend(`<div class="bulletin-item" data-id="${canCreateBulletin}">
                ...
                <div class="bulletin-date">${MyName} - Nesse Momento</div>
                </div>
            </div>`);
    } else {
  ...
  $(".manage-incidents-title-holder").on(
    ...
    function () {
      ...
      <div style="color: white;">
        ...
        <p>&nbsp;</p>
        <p><strong>🗄️ Local das Evidências:</strong> Esconderijo # | Gaveta #</p>
        <p>&nbsp;</p>
        <p><strong>🔪 Armas/Itens Confiscados:</strong></p>
        <p><em>· [Insira a Lista Aqui]</em></p>
        <p>&nbsp;</p>
        <p>-----</p>
        <p><strong style="background-color: var(--color-1);">💸 Multa:</strong></p>
        <p>&nbsp;</p>
  ...
  `;
      ...
      $(".manage-incidents-title-holder").prepend(
        `
            <div class="manage-incidents-title">Gerenciar incidentes</div>
      ...
      if (sourceElement === "incidents-civilians") {
        ...
        $(".incidents-ghost-holder").prepend(
          `
            ...
            <div class="modify-charges-label"><span class="fas fa-solid fa-info"></span> Clique com o botão direito abaixo para adicionar e/ou modificar acusações.</div>
            ...
            <div class="associated-incidents-fine-input" data-id="${$(this).data("cid")}"><img src="img/h7S5f9J.webp"> <input placeholder="Digite a multa aqui..." value="0" class="fine-amount" data-id="${$(this).data("cid")}" type="number"></div>
            <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Sentença</div>
            <div class="associated-incidents-sentence-input" data-id="${$(this).data("cid")}"><img src="img/9Xn6xXK.webp"> <input placeholder="Digite os meses aqui..." value="0" class="sentence-amount" data-id="${$(this).data("cid")}" type="number"></div>
            <div class="associated-incidents-controls" data-id="${$(this).data("cid")}">
                <div id="jail-button" class="control-button" data-id="${$(this).data("cid")}"><span class="fa-solid fa-building-columns" style="margin-top: 3.5px;"></span> Prisão</div>
                <div id="fine-button" class="control-button" data-id="${$(this).data("cid")}"><span class="fa-solid fa-file-invoice-dollar" style="margin-top: 3.5px;"></span> Multa</div>
  ...
  $(".manage-reports-title-holder").on(
    ...
    function () {
      ...
      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
        template = `
    <div style="color: white;">
       <p><strong>Encaminhado para a UTI?: [Sim/Não]</strong></p>
      <p><strong>Relatório do Incidente:</strong></p>
      <p><em>· [ Resumo breve do que aconteceu e quem fez o quê no local. Observe qualquer detalhe que se destacou no local, bem como o que foi feito para tratar o paciente ]</em></p>
      <p><strong>Lista de Lesões:</strong></p>
      <p><em>· [ Informe quais lesões ocorreram ]</em></p>
      <p><strong>Relatório Cirúrgico:</strong></p>
      <p><em>· [ Relatório completo sobre o que foi feito na cirurgia, liste quaisquer complicações ou o que foi encontrado durante a operação. Anote quem estava presente e o que fizeram durante a cirurgia. Ao final do relatório, certifique-se de anotar o estado do paciente após a cirurgia ]</em></p>
      <p>-----</p>
      <p><strong>Atendentes:</strong></p>
      <p><em>· [ Liste os Atendentes Aqui ]</em></p>
      <p><strong>Medicações Aplicadas:</strong></p>
      <p><em>· [ Liste as Medicações Aqui ]</em></p>
      <p>-----</p>
      <br>
        ...
        if (LastName == value.name) {
          $(".dispatch-items").append(`
                    <div class="dispatch-item-grid dispatch-item-msg">
                        <div class="dispatch-item-message" data-author="${value.name}">${sanitizeHTML(value.message)}</div>
                    </div>
                    `);
        } else {
          if (DispatchNum == 1) {
            $(".dispatch-items")
              .append(`<div class="dispatch-item" style="display: flex; margin-top: 0vh;" >
                ...
                }">${sanitizeHTML(value.message)}</div>
                        </div>
                        </div>`);
          } else {
            $(".dispatch-items")
...
var customImageUrl = 'img/map.jpg';
